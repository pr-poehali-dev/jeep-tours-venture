          ...
          <div className="grid md:grid-cols-3 gap-8">
            {tours.map((tour) => (
              <Card key={tour.id} className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600 mb-4">Долина Привидений, Места съемок кавказской пленницы, Крепость Фуна, Буковый Лес, Смотровая площадка</p>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-12">
            ...
            <div className="flex items-center text-white">
              ...
              <div>
                <p className="font-semibold">info@jeeptours.ru</p>
